...
export default function () {
  Post.count().exec((err, count) => {
    ...
    const post1 = new Post({ username: 'hugoce17@gmail.com', title: 'Hello Magic Leap', slug: 'hello-magic-leap', cuid: 'cikqgkv4q01ck7453ualdn3hd', content: content1 });
    const post2 = new Post({ username: 'hugoce17@gmail.com', title: 'Lorem Ipsum', slug: 'lorem-ipsum', cuid: 'cikqgkv4q01ck7453ualdn3hf', content: content2 });
